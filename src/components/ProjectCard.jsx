function ProjectCard({ title, dates, image, alt, description, link }) {
    return (
            <div className='flex items-center bg-slate-800 bg-opacity-50 rounded-md p-14 w-[75%] lg:w-[45%] mx-auto mb-12 shadow-gray-900 shadow-[4px_4px_0px_0px] animate-fade animate-once animate-duration-[2000ms] animate-ease-in-out'>
                <div>
                { /* Image */ }
